...
web build:
 - http://mootools.net/core/9410a25df96609a6fb0816d64130bce3

packager build:
 - packager build Core/Element Core/Request.JSON Core/DOMReady
...
}});return d.join("&");}});})();Hash.implement({has:Object.prototype.hasOwnProperty,keyOf:function(a){return Object.keyOf(this,a);},hasValue:function(a){return Object.contains(this,a);
...
Element.Events=new Hash(Element.Events);})();(function(i,k){var l,f,e=[],c,b,d=k.createElement("div");var g=function(){clearTimeout(b);if(l){return;}Browser.loaded=l=true;
